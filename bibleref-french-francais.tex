...
Le package fournit des options pour un meilleur tri\footcite[En ce qui concerne la différence entre canon juif / protestant et canon catholique, les auteurs de ce package se sont basés sur le tableau situé dans][]{canons}. Au chargement du package, vous pouvez choisir l'une de ces options :
 \begin{description}
